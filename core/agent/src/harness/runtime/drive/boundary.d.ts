...
import type { Config, Drive, LaneState, ProcedureResult } from "../types.ts";
...
export declare function normalizedRetryPolicy<TContext extends object | undefined>(configurationOrLane: Lane<TContext> | Config<TContext>): NormalizedRetryPolicy;
export declare function assistantReadyAtBoundary<TContext extends object | undefined>(lane: Lane<TContext>, state: LaneState, scope: OperationScope, triggerEntryId: string, overflowRecoveryUsed: boolean, configuration?: Config<TContext>): AssistantReadyOperation;
