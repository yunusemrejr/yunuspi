...
${chalk.bold("Environment Variables:")}
  ...
  META_API_KEY                     - Meta Model API key (Muse subscription via /login)
  STEPFUN_API_KEY                  - StepFun API key
  STEPFUN_STEP_PLAN_API_KEY        - StepFun Step Plan API key (China region)
  STEPFUN_AI_STEP_PLAN_API_KEY     - StepFun Step Plan API key (International region)
