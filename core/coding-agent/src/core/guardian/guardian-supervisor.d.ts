...
export declare function relayIntelligenceUsageFromChild(input: { name: "JEV" | "Needle3" | "FuzzyML" | "Kompress" | "Local LM" | "retrieval" | "Neural ranker" | "Intent classifier" | "WASM source check" | "Deterministic selection"; sessionId: string; ownerId: string; stage?: "result" | "cached" | "applied" | "delivered" | "returned" | "skipped"; source?: "remote" | "local" | "wasm"; count?: number; durationMs?: number; savedChars?: number }): boolean;
