...
// PI_IMAGE_BUDGET (local patch; re-applied by verify-harness.mjs): the stock default
...
// scripts/patches/request-body-gate.mjs (PI_BODY_GATE enforces the total).
const DEFAULT_MAX_BYTES = 1572864;
