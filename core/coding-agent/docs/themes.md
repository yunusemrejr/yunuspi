...
```json
{
  "$schema": "https://raw.githubusercontent.com/yunusemrejr/yunuspi/main/core/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
