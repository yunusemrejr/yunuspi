...
See [examples/sdk/](https://github.com/earendil-works/pi/tree/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/) for working examples from minimal to full control.

## Quick Start

```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "@yunuspi/coding-agent";
...
Run these commands in a reviewed YunusPi checkout; the owned SDK is a local workspace package, not an upstream npm dependency.
...
```typescript
import { createAgentSession, SessionManager } from "@yunuspi/coding-agent";
...
The `Agent` class (from `@yunuspi/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { ModelRuntime } from "@yunuspi/coding-agent";
...
> See [examples/sdk/02-custom-model.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/02-custom-model.ts)
...
```typescript
import { InMemoryCredentialStore } from "@yunuspi/ai";
import { createAgentSession, ModelRuntime } from "@yunuspi/coding-agent";
...
> See [examples/sdk/09-api-keys-and-oauth.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/09-api-keys-and-oauth.ts)
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@yunuspi/coding-agent";
...
> See [examples/sdk/03-custom-prompt.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/03-custom-prompt.ts)
...
```typescript
import { createAgentSession } from "@yunuspi/coding-agent";
...
> See [examples/sdk/05-tools.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/05-tools.ts)

### Custom Tools

```typescript
import { Type } from "typebox";
import { createAgentSession, defineTool } from "@yunuspi/coding-agent";
...
```typescript
import type { InlineExtension } from "@yunuspi/coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@yunuspi/coding-agent";
...
> See [examples/sdk/06-extensions.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/06-extensions.ts) and [docs/extensions.md](extensions.md)
...
> See [examples/sdk/04-skills.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/04-skills.ts)
...
> See [examples/sdk/07-context-files.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/07-context-files.ts)
...
> See [examples/sdk/08-prompt-templates.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/08-prompt-templates.ts)
...
> See [examples/sdk/11-sessions.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/11-sessions.ts) and [Session Format](session-format.md)

### Settings Management

```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@yunuspi/coding-agent";
...
> See [examples/sdk/10-settings.ts](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/packages/coding-agent/examples/sdk/10-settings.ts)
