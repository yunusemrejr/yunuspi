...
| `PI_OFFLINE` | Disable optional startup package and catalog network operations; core release checks do not exist |
| `PI_TELEMETRY` | Retained provider-attribution compatibility control; no upstream install telemetry is sent |
...
The upstream experimental remote harness is not included in this fork.
