...
- run the whole `yunuspi` process inside a container/sandbox
...
To report a security issue, follow the repository [Security Policy](https://github.com/earendil-works/pi/blob/d981de1229ef899957bbe968bc8dcda02a21f477/SECURITY.md). Do not open a public issue for security-sensitive reports.
