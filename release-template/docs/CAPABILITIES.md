...
- `obs_read` — [`agent/extensions/pi-observations.ts`](../../agent/extensions/pi-observations.ts) (line 295; literal)
...
- /cost — [`agent/extensions/session-signals.ts`](../../agent/extensions/session-signals.ts) (line 59)
...
- /obs — [`agent/extensions/pi-observations.ts`](../../agent/extensions/pi-observations.ts) (line 348)
...
- /reminder — [`agent/extensions/reminders.ts`](../../agent/extensions/reminders.ts) (line 931)
