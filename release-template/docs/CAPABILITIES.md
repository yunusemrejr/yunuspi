...
- `obs_read` — [`agent/extensions/pi-observations.ts`](../../agent/extensions/pi-observations.ts) (line 815; literal)
...
- /errors — [`agent/extensions/session-signals.ts`](../../agent/extensions/session-signals.ts) (line 1738)
...
- /sys-prompt — [`agent/extensions/session-signals.ts`](../../agent/extensions/session-signals.ts) (line 1696)
...
- /used — [`agent/extensions/session-signals.ts`](../../agent/extensions/session-signals.ts) (line 1715)
