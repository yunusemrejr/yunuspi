...
- `project_tests` — [`agent/extensions/lib/project-tests.ts`](../../agent/extensions/lib/project-tests.ts) (line 449; literal)
...
- `skill_review` — [`agent/extensions/lib/relevant-guidance.ts`](../../agent/extensions/lib/relevant-guidance.ts) (line 600; literal)
...
- [`agent/scripts/patches/pi-lens-indent-comments.mjs`](../../agent/scripts/patches/pi-lens-indent-comments.mjs) (source type `mjs`)
