...
test('common observed failures give specific recovery instead of unclassified',()=>{
 ...
 ['Response truncated: finish_reason=length after 8192 tokens','truncated'],
 ['max_tokens budget exhausted before the final summary','truncated'],
 ['select length, budget from quarterly_report','unclassified'],
 ['select quota, budget from quarterly_report','unclassified'],
 ['contract terms and conditions','unclassified'],
 ['Path outside scope','permission'],
 ['quota exceeded for this key','capacity'],
 ['request to https://x timed out after 30000ms','timeout'],
 ['acceptance failed: missing tests','verification'],
