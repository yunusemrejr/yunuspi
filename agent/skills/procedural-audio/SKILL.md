...
description: Generate music beds and sound effects procedurally in Python (numpy) for videos, apps and games; seeded chord-progression ambience with intensity automation, and designed whooshes, risers, impacts, ticks and chimes, plus mixing and loudness discipline. Use when a project needs original music or sound without samples, stock audio or generative AI audio.
---
...
- Under narration, keep tempo 70–90 bpm, low `pulse`/`bell` layers, and a dark bed (little energy above 2 kHz). Speech intelligibility lives around 1–4 kHz.
- Use sound effects as punctuation for specific visual events, one per idea, 6–12 dB under the voice.
