...
- `src/primitives/` holds reusable visuals: `Stage`, `Backdrop`, `ParticleField`, `Heading`, `TokenRow`, `NeuralNet`, `Matrix`, `Graph`, `BarChart`, `TimelineAxis` and `CodeBlock`. They take data and 0..1 progress values and contain no timing.
