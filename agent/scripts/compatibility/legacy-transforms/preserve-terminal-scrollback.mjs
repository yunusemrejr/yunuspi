...
export function targets() {
  ...
  const core = process.env.PI_HARNESS_PATCH_TEST_CORE ?? path.join(execFileSync('npm', ['root', '-g'], { encoding: 'utf8' }).trim(), '@yunuspi/coding-agent');
  ...
  const sdk = path.join(core, 'node_modules/@yunuspi/tui/dist/tui-main-screen.js');
