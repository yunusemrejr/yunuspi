...
function addTargetedNames({ file, source, relativePath, stable, owners }) {
	...
	if (relativePath === "extensions/lib/small-tools.ts" || relativePath === "extensions/media-tools.ts" || relativePath === "extensions/pi-subagents/src/extension/reasoning-aids.ts") {
	...
	for (const call of calls) {
		...
		if (relativePath === "extensions/lib/small-tools.ts" || relativePath === "extensions/media-tools.ts" || relativePath === "extensions/pi-subagents/src/extension/reasoning-aids.ts") signal = "registration passes names through a local factory; literal factory call sites are enumerated";
