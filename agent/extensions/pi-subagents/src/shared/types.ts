...
export interface SingleResult {
	...
	reviewEvidence?: { sourceReads: number; sourcePaths?: string[] };
	artifactPaths?: ArtifactPaths;
...
export interface AsyncStatus {
	...
	usageBudget?: UsageBudgetState;
	pid?: number;
	/** Kernel process-start identity (Linux jiffies) recorded by the runner so stale-run
	 *  reconciliation can verify the live PID still belongs to this run and not a recycled one. */
