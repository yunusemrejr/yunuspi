...
export const READ_ONLY_REASONING_TOOLS = ["dependency_plan", "decision_frontier", "coverage_select", "math_check", "artifact_check", "value_convert", "context_slice", "symbol_expand", "ast_diff", "obs_read", "sandbox_run", "project_intel"] as const;
