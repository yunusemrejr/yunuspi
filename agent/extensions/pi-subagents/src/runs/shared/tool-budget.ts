...
export const READ_ONLY_REASONING_TOOLS = ["sqlite_probe", "package_probe", "openapi_probe", "coverage_probe", "contract_diff", "env_audit", "net_probe", "archive_probe", "skill_review", "workspace_search", "local_mail_search", "local_mail_read", "ssh_plan", "dependency_plan", "decision_frontier", "coverage_select", "math_check", "artifact_check", "value_convert", "context_slice", "symbol_expand", "ast_diff", "syntax_check", "obs_read", "project_intel", "sandbox_run", "git_info"] as const;
