...
tools: read, grep, find, ls, bash, dependency_plan, decision_frontier, coverage_select, math_check, artifact_check, value_convert, data_query, git_info, http_request, sys_probe, context_slice, symbol_expand, ast_diff, obs_read
