...
export default function (pi: any) {
  ...
  pi.registerTool({
    ...
    description: "Inspect a rendered web page for typography/spacing distributions, repeated surface effects, overflow, running motion and solid-color text contrast. Includes bounded visible placeholder-copy and exact adjacent-label/link repetition candidates; intentional repetition is allowed. Uses the existing isolated browser, with screenshot pixels for vision models. Numeric evidence for accessible and anti-slop design review, not a style score or certification. Complex paint is indeterminate. Compare mobile/desktop and reduced-motion calls; use design skills and actual screenshots to judge hierarchy and originality.",
