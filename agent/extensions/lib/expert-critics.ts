...
export const LENS_CATALOG: Record<string, CriticLens> = {
  "art-direction": lens("art-direction", "Art direction", "model", "quality_review:interface",
    ["visual_review run on representative captures", "ui_explore viewport/state matrix"],
    "captured pixels at representative sizes/states plus the recorded visual_review verdict",
  ...
  "typography-composition": lens("typography-composition", "Typography and composition", "model", "quality_review:interface",
    ["ui_explore viewport/state matrix", "code_quality slop on new styles"],
  ...
  "color-brand": lens("color-brand", "Color and brand", "model", "quality_review:interface",
    ["design_audit on representative captures", "visual_review run with recorded verdict"],
  ...
  "responsive-state": lens("responsive-state", "Responsive behavior and states", "model", "quality_review:interface",
    ["ui_explore viewport/state matrix", "browser_session representative task pass"],
  ...
  originality: lens("originality", "Originality", "model", "quality_review:interface",
    ["visual_review run with direction conformance", "creative_compare concept variants"],
  ...
  "information-architecture": lens("information-architecture", "Information architecture", "model", "quality_review:interface",
    ["ui_explore viewport/state matrix", "render_see task-path captures"],
    "task-path captures plus navigation and heading structure",
    "Judge architecture over styling: one obvious route per goal, honest heading hierarchy, a single CTA hierarchy, no duplicated destinations or dead-end states. Verbose navigation and buried key actions are findings; pretty pages with stupid paths fail."),
  "svg-geometry": lens("svg-geometry", "SVG geometry", "deterministic", "checks-only",
    ["svg_inspect on every shipped file", "artifact_check svg on every shipped file"],
    "clean svg_inspect and artifact_check svg receipts",
  ...
  "svg-small-size": lens("svg-small-size", "SVG small-size behavior", "model", "quality_review:interface",
    ["svg_inspect render matrix at 16/24/48px", "svg_inspect set review across icon files"],
  ...
  "timing-rhythm": lens("timing-rhythm", "Timing and rhythm", "model", "quality_review:interface",
    ["motion_inspect timeline and temporal QA", "math_check frame_budget on measured frames"],
