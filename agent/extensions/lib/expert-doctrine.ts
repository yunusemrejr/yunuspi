...
export const EXPERT_PACKS: Record<ExpertDomainId, DoctrinePack> = {
  "web-design": pack("web-design", {
    ...
    checks: [
      ...
      { tool: "render_see", what: "Bounded rendered inspection at representative viewports." },
      { tool: "code_quality", op: "slop", what: "AI-template tells in new markup/styles." },
      { tool: "web_asset_check", what: "Asset weight, dimensions and format sanity." },
    ],
    skills: ["frontend-design", "ui-ux-principles", "anti-ai-slop", "product-ui-verification"],
    tools: ["browser_session", "render_see", "design_audit", "web_asset_check", "media_info"],
    lenses: ["art-direction", "typography-composition", "color-brand", "responsive-state", "originality"],
    evidence: ["captured pixels at 2+ viewports", "interaction pass over key flows", "states (loading/empty/error) shown"],
  ...
  "visual-art": pack("visual-art", {
    ...
    tools: ["media_info", "media_edit", "render_see", "image_ocr", "scene_render"],
  ...
  "svg-iconography": pack("svg-iconography", {
    ...
    checks: [
      ...
      { tool: "render_see", what: "Rasterized inspection at 16/24/48px representative sizes." },
      { tool: "code_quality", op: "duplicates", what: "Copy-pasted defs shared across icon files." },
    ],
    skills: ["custom-svg", "svg-assessment"],
    tools: ["render_see", "media_info", "browser_session"],
    lenses: ["svg-geometry", "svg-small-size", "originality"],
    evidence: ["rasterized 16/24/48px captures", "clean artifact_check svg receipt"],
  ...
  "motion-design": pack("motion-design", {
    ...
    checks: [
      ...
      { tool: "render_see", what: "Captured sequence inspection at key frames." },
