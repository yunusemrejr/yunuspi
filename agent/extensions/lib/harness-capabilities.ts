...
export const HARNESS_CAPABILITIES: readonly HarnessCapability[] = Object.freeze([
	...
	capability({
		...
		commands: [
			...
			"sys-prompt", "used", "errors", "commands",
		],
		options: [
			...
			option("/sys-prompt|/used|/errors|/commands", "Separate-window popups: opening system prompt, session usage, detailed error JSON, command list."),
