...
- `bg_status` — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 720; literal)
...
- `fetch_content` — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 193; configured-default)
- `get_search_content` — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 194; configured-default)
...
- `memory_search` — [`agent/extensions/pi-memory/index.ts`](../agent/extensions/pi-memory/index.ts) (line 2748; literal)
...
- `session_audit` — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1800; literal)
- `session_coordinate` — [`agent/extensions/siblings.ts`](../agent/extensions/siblings.ts) (line 584; literal)
- `session_self` — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1737; literal)
...
- `source_check` — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 192; configured-default)
- `sqlite_probe` — [`agent/extensions/lib/utility-mcp/catalog.mjs`](../agent/extensions/lib/utility-mcp/catalog.mjs) (line 12; catalog)
- `structured_output` — [`agent/extensions/pi-subagents/src/runs/shared/subagent-prompt-runtime.ts`](../agent/extensions/pi-subagents/src/runs/shared/subagent-prompt-runtime.ts) (line 837; literal)
...
- `sys_probe` — [`agent/extensions/sys-probe.ts`](../agent/extensions/sys-probe.ts) (line 250; literal)
...
- `web_search` — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 191; configured-default)
...
- [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) — registration uses configurable toolNames; checked-in defaults are enumerated; known tools: `fetch_content`, `get_search_content`, `source_check`, `web_search` (lines 1656, 2244, 2398, 2797)
...
- /commands — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1708)
- /cost — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1310)
- /curator — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 3392)
- /effort — [`agent/extensions/thinking.ts`](../agent/extensions/thinking.ts) (line 48)
- /errors — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1682)
- /export-json — [`agent/extensions/session-export-json.ts`](../agent/extensions/session-export-json.ts) (line 49)
- /google-account — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 3434)
...
- /obs — [`agent/extensions/pi-observations.ts`](../agent/extensions/pi-observations.ts) (line 892)
...
- /search — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 3482)
- /self — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1635)
...
- /subagents-detach — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 992)
- /subagents-doctor — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 921)
- /subagents-fleet — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 958)
- /subagents-generate-profiles — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 1240)
- /subagents-inspect-rpc — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 928)
- /subagents-load-profile — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 1153)
- /subagents-models — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 1123)
- /subagents-profiles — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 1141)
- /subagents-refine — [`agent/extensions/pi-subagents/src/slash/slash-commands.ts`](../agent/extensions/pi-subagents/src/slash/slash-commands.ts) (line 945)
...
- /sys-prompt — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1640)
...
- /used — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1659)
- /websearch — [`agent/extensions/pi-web-access/index.ts`](../agent/extensions/pi-web-access/index.ts) (line 3131)
...
- [`agent/scripts/compatibility/legacy-transforms/autonomous-recovery.mjs`](../agent/scripts/compatibility/legacy-transforms/autonomous-recovery.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/background-task-signal-status.mjs`](../agent/scripts/compatibility/legacy-transforms/background-task-signal-status.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/background-task-terminal-publish.mjs`](../agent/scripts/compatibility/legacy-transforms/background-task-terminal-publish.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/cache-hit-footer.mjs`](../agent/scripts/compatibility/legacy-transforms/cache-hit-footer.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/cache-usage-accuracy.mjs`](../agent/scripts/compatibility/legacy-transforms/cache-usage-accuracy.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/calculate-cost.js`](../agent/scripts/compatibility/legacy-transforms/calculate-cost.js) (source type `js`)
- [`agent/scripts/compatibility/legacy-transforms/catalog-refresh-credential-gate.mjs`](../agent/scripts/compatibility/legacy-transforms/catalog-refresh-credential-gate.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/compaction-early.mjs`](../agent/scripts/compatibility/legacy-transforms/compaction-early.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/context-settings.mjs`](../agent/scripts/compatibility/legacy-transforms/context-settings.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/edit-optimistic-concurrency.mjs`](../agent/scripts/compatibility/legacy-transforms/edit-optimistic-concurrency.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/export-redaction.mjs`](../agent/scripts/compatibility/legacy-transforms/export-redaction.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/hook-metrics-wrapper.js`](../agent/scripts/compatibility/legacy-transforms/hook-metrics-wrapper.js) (source type `js`)
- [`agent/scripts/compatibility/legacy-transforms/hook-metrics.mjs`](../agent/scripts/compatibility/legacy-transforms/hook-metrics.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/local-context-allocation.mjs`](../agent/scripts/compatibility/legacy-transforms/local-context-allocation.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/model-selector-custom.mjs`](../agent/scripts/compatibility/legacy-transforms/model-selector-custom.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/mutation-path-boundary.mjs`](../agent/scripts/compatibility/legacy-transforms/mutation-path-boundary.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/native-read-mutation-queue.mjs`](../agent/scripts/compatibility/legacy-transforms/native-read-mutation-queue.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/notify-broker-delivery.mjs`](../agent/scripts/compatibility/legacy-transforms/notify-broker-delivery.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/openai-service-pricing.js`](../agent/scripts/compatibility/legacy-transforms/openai-service-pricing.js) (source type `js`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-atomic-preflight.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-atomic-preflight.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-autofix-debounce.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-autofix-debounce.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-compact-reports.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-compact-reports.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-diagnostic-scope.md`](../agent/scripts/compatibility/legacy-transforms/pi-lens-diagnostic-scope.md) (source type `md`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-diagnostic-scope.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-diagnostic-scope.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-feedback-notices.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-feedback-notices.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-format-safety.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-format-safety.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-fuzzy-identifiers.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-fuzzy-identifiers.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-indent-comments.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-indent-comments.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-radar-state.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-radar-state.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-read-guard.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-read-guard.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-semantic-dry.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-semantic-dry.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-tool-result-profile.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-tool-result-profile.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/pi-lens-workspace-facts.mjs`](../agent/scripts/compatibility/legacy-transforms/pi-lens-workspace-facts.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/preserve-terminal-scrollback.mjs`](../agent/scripts/compatibility/legacy-transforms/preserve-terminal-scrollback.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/provider-price-accuracy.mjs`](../agent/scripts/compatibility/legacy-transforms/provider-price-accuracy.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/README.md`](../agent/scripts/compatibility/legacy-transforms/README.md) (source type `md`)
- [`agent/scripts/compatibility/legacy-transforms/request-body-gate.mjs`](../agent/scripts/compatibility/legacy-transforms/request-body-gate.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/retry-429-policy.mjs`](../agent/scripts/compatibility/legacy-transforms/retry-429-policy.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/search-output-spill.mjs`](../agent/scripts/compatibility/legacy-transforms/search-output-spill.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/session-cost-display.js`](../agent/scripts/compatibility/legacy-transforms/session-cost-display.js) (source type `js`)
- [`agent/scripts/compatibility/legacy-transforms/stream-idle.mjs`](../agent/scripts/compatibility/legacy-transforms/stream-idle.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/summary-effort.mjs`](../agent/scripts/compatibility/legacy-transforms/summary-effort.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/thinking-reflow.mjs`](../agent/scripts/compatibility/legacy-transforms/thinking-reflow.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/token-budget.mjs`](../agent/scripts/compatibility/legacy-transforms/token-budget.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/tool-validation.mjs`](../agent/scripts/compatibility/legacy-transforms/tool-validation.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/truncation-context.mjs`](../agent/scripts/compatibility/legacy-transforms/truncation-context.mjs) (source type `mjs`)
- [`agent/scripts/compatibility/legacy-transforms/tui-branding.mjs`](../agent/scripts/compatibility/legacy-transforms/tui-branding.mjs) (source type `mjs`)
