...
- `project_memory_index_path` — [`agent/extensions/pi-vector-memory.ts`](../agent/extensions/pi-vector-memory.ts) (line 666; literal)
- `project_memory_read` — [`agent/extensions/pi-vector-memory.ts`](../agent/extensions/pi-vector-memory.ts) (line 456; literal)
- `project_memory_reembed` — [`agent/extensions/pi-vector-memory.ts`](../agent/extensions/pi-vector-memory.ts) (line 586; literal)
- `project_memory_remember` — [`agent/extensions/pi-vector-memory.ts`](../agent/extensions/pi-vector-memory.ts) (line 616; literal)
...
- /commands — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1810)
- /cost — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1391)
...
- /errors — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1776)
...
- /self — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1720)
...
- /sys-prompt — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 1725)
