...
- `obs_read` — [`agent/extensions/pi-observations.ts`](../agent/extensions/pi-observations.ts) (line 526; literal)
...
- /obs — [`agent/extensions/pi-observations.ts`](../agent/extensions/pi-observations.ts) (line 579)
