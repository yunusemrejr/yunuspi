...
- `bg_kill` — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 829; literal)
- `bg_logs` — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 783; literal)
- `bg_run` — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 668; literal)
- `bg_status` — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 752; literal)
...
- `checkpoint_read` — [`agent/extensions/checkpoints.ts`](../agent/extensions/checkpoints.ts) (line 194; literal)
...
- `project_intel` — [`agent/extensions/project-intelligence.ts`](../agent/extensions/project-intelligence.ts) (line 683; literal)
- `quality_review` — [`agent/extensions/lib/quality-review.ts`](../agent/extensions/lib/quality-review.ts) (line 377; literal)
...
- `skill_review` — [`agent/extensions/lib/relevant-guidance.ts`](../agent/extensions/lib/relevant-guidance.ts) (line 564; literal)
...
- `subagent` — [`agent/extensions/pi-subagents/src/extension/index.ts`](../agent/extensions/pi-subagents/src/extension/index.ts) (line 711; definition)
...
- [`agent/extensions/pi-subagents/src/extension/index.ts`](../agent/extensions/pi-subagents/src/extension/index.ts) — registration receives the source-owned subagent definition; known tools: `subagent` (lines 761)
...
- /bg — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 502)
- /bg-clear — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 544)
- /bg-tasks — [`agent/extensions/pi-background-tasks/src/extension.ts`](../agent/extensions/pi-background-tasks/src/extension.ts) (line 536)
...
- /graph — [`agent/extensions/project-intelligence.ts`](../agent/extensions/project-intelligence.ts) (line 807)
- /harness-backup — [`agent/extensions/harness-backup.ts`](../agent/extensions/harness-backup.ts) (line 37)
- /hook-audit — [`agent/extensions/lib/session-telemetry.ts`](../agent/extensions/lib/session-telemetry.ts) (line 55)
...
- /lens-allow-edit — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113703)
- /lens-context-toggle — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113407)
- /lens-drift — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113464)
- /lens-health — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113499)
- /lens-map — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113476)
- /lens-perf — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113618)
- /lens-tdi — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113432)
- /lens-toggle — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113400)
- /lens-tools — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113637)
- /lens-widget-toggle — [`agent/extensions/pi-lens/dist/index.js`](../agent/extensions/pi-lens/dist/index.js) (line 113414)
...
- /self — [`agent/extensions/session-signals.ts`](../agent/extensions/session-signals.ts) (line 525)
...
- [`agent/scripts/patches/autonomous-recovery.mjs`](../agent/scripts/patches/autonomous-recovery.mjs) (source type `mjs`)
- [`agent/scripts/patches/background-task-signal-status.mjs`](../agent/scripts/patches/background-task-signal-status.mjs) (source type `mjs`)
- [`agent/scripts/patches/background-task-terminal-publish.mjs`](../agent/scripts/patches/background-task-terminal-publish.mjs) (source type `mjs`)
- [`agent/scripts/patches/cache-hit-footer.mjs`](../agent/scripts/patches/cache-hit-footer.mjs) (source type `mjs`)
- [`agent/scripts/patches/cache-usage-accuracy.mjs`](../agent/scripts/patches/cache-usage-accuracy.mjs) (source type `mjs`)
- [`agent/scripts/patches/calculate-cost.js`](../agent/scripts/patches/calculate-cost.js) (source type `js`)
- [`agent/scripts/patches/catalog-refresh-credential-gate.mjs`](../agent/scripts/patches/catalog-refresh-credential-gate.mjs) (source type `mjs`)
- [`agent/scripts/patches/compaction-early.mjs`](../agent/scripts/patches/compaction-early.mjs) (source type `mjs`)
- [`agent/scripts/patches/context-settings.mjs`](../agent/scripts/patches/context-settings.mjs) (source type `mjs`)
- [`agent/scripts/patches/edit-optimistic-concurrency.mjs`](../agent/scripts/patches/edit-optimistic-concurrency.mjs) (source type `mjs`)
- [`agent/scripts/patches/export-redaction.mjs`](../agent/scripts/patches/export-redaction.mjs) (source type `mjs`)
- [`agent/scripts/patches/hook-metrics-wrapper.js`](../agent/scripts/patches/hook-metrics-wrapper.js) (source type `js`)
- [`agent/scripts/patches/hook-metrics.mjs`](../agent/scripts/patches/hook-metrics.mjs) (source type `mjs`)
- [`agent/scripts/patches/local-context-allocation.mjs`](../agent/scripts/patches/local-context-allocation.mjs) (source type `mjs`)
- [`agent/scripts/patches/model-selector-custom.mjs`](../agent/scripts/patches/model-selector-custom.mjs) (source type `mjs`)
- [`agent/scripts/patches/mutation-path-boundary.mjs`](../agent/scripts/patches/mutation-path-boundary.mjs) (source type `mjs`)
- [`agent/scripts/patches/native-read-mutation-queue.mjs`](../agent/scripts/patches/native-read-mutation-queue.mjs) (source type `mjs`)
- [`agent/scripts/patches/notify-broker-delivery.mjs`](../agent/scripts/patches/notify-broker-delivery.mjs) (source type `mjs`)
- [`agent/scripts/patches/openai-service-pricing.js`](../agent/scripts/patches/openai-service-pricing.js) (source type `js`)
- [`agent/scripts/patches/pi-lens-atomic-preflight.mjs`](../agent/scripts/patches/pi-lens-atomic-preflight.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-autofix-debounce.mjs`](../agent/scripts/patches/pi-lens-autofix-debounce.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-compact-reports.mjs`](../agent/scripts/patches/pi-lens-compact-reports.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-diagnostic-scope.md`](../agent/scripts/patches/pi-lens-diagnostic-scope.md) (source type `md`)
- [`agent/scripts/patches/pi-lens-diagnostic-scope.mjs`](../agent/scripts/patches/pi-lens-diagnostic-scope.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-feedback-notices.mjs`](../agent/scripts/patches/pi-lens-feedback-notices.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-format-safety.mjs`](../agent/scripts/patches/pi-lens-format-safety.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-fuzzy-identifiers.mjs`](../agent/scripts/patches/pi-lens-fuzzy-identifiers.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-radar-state.mjs`](../agent/scripts/patches/pi-lens-radar-state.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-read-guard.mjs`](../agent/scripts/patches/pi-lens-read-guard.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-semantic-dry.mjs`](../agent/scripts/patches/pi-lens-semantic-dry.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-tool-result-profile.mjs`](../agent/scripts/patches/pi-lens-tool-result-profile.mjs) (source type `mjs`)
- [`agent/scripts/patches/pi-lens-workspace-facts.mjs`](../agent/scripts/patches/pi-lens-workspace-facts.mjs) (source type `mjs`)
- [`agent/scripts/patches/post-update-repair.mjs`](../agent/scripts/patches/post-update-repair.mjs) (source type `mjs`)
- [`agent/scripts/patches/preserve-terminal-scrollback.mjs`](../agent/scripts/patches/preserve-terminal-scrollback.mjs) (source type `mjs`)
- [`agent/scripts/patches/provider-price-accuracy.mjs`](../agent/scripts/patches/provider-price-accuracy.mjs) (source type `mjs`)
- [`agent/scripts/patches/request-body-gate.mjs`](../agent/scripts/patches/request-body-gate.mjs) (source type `mjs`)
- [`agent/scripts/patches/retry-429-policy.mjs`](../agent/scripts/patches/retry-429-policy.mjs) (source type `mjs`)
- [`agent/scripts/patches/search-output-spill.mjs`](../agent/scripts/patches/search-output-spill.mjs) (source type `mjs`)
- [`agent/scripts/patches/session-cost-display.js`](../agent/scripts/patches/session-cost-display.js) (source type `js`)
- [`agent/scripts/patches/stream-idle.mjs`](../agent/scripts/patches/stream-idle.mjs) (source type `mjs`)
- [`agent/scripts/patches/summary-effort.mjs`](../agent/scripts/patches/summary-effort.mjs) (source type `mjs`)
- [`agent/scripts/patches/thinking-reflow.mjs`](../agent/scripts/patches/thinking-reflow.mjs) (source type `mjs`)
- [`agent/scripts/patches/token-budget.mjs`](../agent/scripts/patches/token-budget.mjs) (source type `mjs`)
- [`agent/scripts/patches/tool-validation.mjs`](../agent/scripts/patches/tool-validation.mjs) (source type `mjs`)
- [`agent/scripts/patches/truncation-context.mjs`](../agent/scripts/patches/truncation-context.mjs) (source type `mjs`)
- [`agent/scripts/patches/tui-branding.mjs`](../agent/scripts/patches/tui-branding.mjs) (source type `mjs`)
