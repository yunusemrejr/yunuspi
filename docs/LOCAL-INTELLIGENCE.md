...
Kompress warms once when its shared service starts, before accepting requests. Clients no longer consume the shared ten-second inference slot for redundant warmups. Valid refusals and busy responses keep the ordinary cooldown and appear as skipped work; malformed responses and timeouts appear as errors.
